...
import LinkedInIcon from "../../public/images/linkicon.svg";
      ...
      <div className="flex flex-col gap-9 p-[24px]">
        <nav className="hidden md:flex justify-between items-center px-[20px] bg-[#FFFFFF] rounded-xl text-[16px] font-[600] leading-[24px] h-[78px] sticky top-0 z-10">
          ...
          <div className="flex items-center">
            <Link href="/profile" className="bg-[#EFEBFF] rounded-lg h-[46px] w-[122px] flex gap-2 items-center justify-center text-[#633CFF]">
              <Image
          ...
          <Link href="/preview" className="flex items-center justify-center text-[#633CFF] hover:bg-[#EFEBFF] rounded-lg h-[46px] w-[114px] border border-[#633CFF]">
            Preview
          </Link>
        </nav>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 w-[100%]">
          <div className="flex justify-center items-center lg:w-[40%] w-full bg-[#FFFFFF] h-[834px] rounded-xl">
          ...
          <div className="lg:w-[60%] w-full flex flex-col justify-between bg-[#FFFFFF] h-[834px] rounded-xl">
            ...
            <div className="h-[95px] flex justify-end items-center font-[600] text-[16px] leading-[24px] text-[#FFFFFF] px-[40px] border-t-[2px] border-t-[#ececec]">
              <button className="bg-[#633CFF] rounded-lg h-[46px] w-full lg:w-[91px] opacity-15 btn">
                Save
              </button>
            </div>
          </div>
